...
5. [#57 UI: Beer Management Table (admin)](https://github.com/pmconnolly80/FinalCapstone/issues/57)
   — depends on #56 — done, [PR #64](https://github.com/pmconnolly80/FinalCapstone/pull/64) (open)
