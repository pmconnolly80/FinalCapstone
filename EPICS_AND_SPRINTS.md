...
3. [#55 UI: User Management screen](https://github.com/pmconnolly80/FinalCapstone/issues/55)
   — depends on #54 (and #53 for role assignment) — done, [PR #62](https://github.com/pmconnolly80/FinalCapstone/pull/62) (open)
