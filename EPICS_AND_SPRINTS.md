...
4. [#56 API: audited beer edit/delete + inline availability update](https://github.com/pmconnolly80/FinalCapstone/issues/56)
   — depends on #53 — done, [PR #63](https://github.com/pmconnolly80/FinalCapstone/pull/63) (open)
